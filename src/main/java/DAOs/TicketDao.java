...
public interface TicketDao {
    ...
    void approveTicket(int t_id, String reason);    //Approve an unresolved Ticket
    void rejectTicket(int t_id, String reason);     //Reject an unresolved Ticket
    ...
    List<Ticket> getAllResolvedTickets(); //Get all the resolved tickets
}
